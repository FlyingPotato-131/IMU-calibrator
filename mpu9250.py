...
class MPU9250:
    ...
    def readAccel(self):
        ...
        self.Accel[0] = self.dataConv(data[1], data[0])
        self.Accel[1] = self.dataConv(data[3], data[2])
        self.Accel[2] = self.dataConv(data[5], data[4])
    ...
    def readGyro(self):
        ...
        self.Gyro[0] = self.dataConv(data[1], data[0])
        self.Gyro[1] = self.dataConv(data[3], data[2])
        self.Gyro[2] = self.dataConv(data[5], data[4])
    ...
    def readMagnet(self):
        ...
        if drdy[0] & 0x01 :
            ...
            # check overflow
            if (data[6] & 0x08)!=0x08:
                self.Mag[0] = self.dataConv(data[0], data[1])
                self.Mag[1] = self.dataConv(data[2], data[3])
                self.Mag[2] = self.dataConv(data[4], data[5])
